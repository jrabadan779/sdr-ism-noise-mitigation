...
class Proyecto1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Proyecto1")
        ...
        self.qtgui_number_sink_1.set_title("Potencia Filtrada")
        ...
        self.qtgui_number_sink_0.set_title("otencia Baseline")
        ...
        self.qtgui_freq_sink_x_0_0 = qtgui.freq_sink_c(
            ...
            0, #fc
            samp_rate, #bw
            "Espectro Baseline FIltrado", #name
            1,
            None # parent
        )
        ...
        # Connections
        ##################################################
        self.connect((self.analog_probe_avg_mag_sqrd_x_0, 0), (self.qtgui_number_sink_0, 0))
        self.connect((self.analog_probe_avg_mag_sqrd_x_0_0, 0), (self.qtgui_number_sink_1, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.channels_channel_model_0, 0))
        self.connect((self.blocks_throttle2_0, 0), (self.analog_probe_avg_mag_sqrd_x_0, 0))
        ...
        self.connect((self.low_pass_filter_0, 0), (self.analog_probe_avg_mag_sqrd_x_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 600e3, 200e3, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=Proyecto1, options=None):
